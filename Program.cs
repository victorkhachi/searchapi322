...
namespace SearchAPI
{
    class Program
    {
        public static void Main(string[] args)
        {
            ...
            Query query = new Query("God is Good.");
            HashSet<Document> queryResults = query.Execute();
            ...
            if (queryResults.Count > 0)
            {
                ...
                {
                    Console.WriteLine("Document ID: " + result.GetID());
                    Console.WriteLine("Title: " + result.GetTitle());
                    Console.WriteLine("Content: " + result.GetContent());
                    Console.WriteLine("URL: " + result.GetURL());
                    Console.WriteLine();
                }
            }
            else
